...
1. Escribe una función que tome la base y la altura de un triángulo y devuelva su área.
triArea(3, 2) ➞ 3

2. Crea una función llamada calculator que recibe 3 parámetros, dos números y una operación matemática
...
- Ingresa al siguiente documento:
    [Ver documento en PDF](ejercicosHackaton.pdf)
