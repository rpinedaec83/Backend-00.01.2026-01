...
### Comando usados en clase

yarn init -y <- inciar un proyecto de nodejs
yarn install <- intalar dependencias
yarn run dev <- ejecutar servidor de manera local
